...
class Ui_NewTaskWindow(object):
    def addNewTask(self, adminUsername, devUsername, db, addTaskToLayoutFunction):
        ...
        # Checking if the entered task name is entered.
        ...
        if self.dateEdit.dateTime() < datetime.now():
            self.ResultLabel.setStyleSheet("color: rgb(255, 0, 0);")
            self.ResultLabel.setText("Geçmişe görev veremezsiniz.")
            self.ResultLabel.setVisible(True)
            return 0         
...
"color: rgb(0, 80, 255);")
        ...
        self.ResultLabel.setGeometry(QtCore.QRect(170, 370, 150, 25))
        self.ResultLabel.setVisible(False)
